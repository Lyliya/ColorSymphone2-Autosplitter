...
{
	//uint ingame : "mono.dll", 0x001F30AC, 0x6C, 0xC, 0x34, 0xC, 0x24, 0x44, 0xAA0;
    //uint lvl : "ColorSymphony2.exe", 0x00EA5930, 0x10, 0x40, 0x0, 0x10, 0x18, 0x2C, 0x4B4;
    //uint endgame : "ColorSymphony2.exe", 0x00EA6838, 0x98, 0x54, 0x8, 0x124, 0x30, 0x4, 0x670;
    uint endgame : "mono.dll", 0x001F30AC, 0x94, 0xC, 0x34, 0xC, 0x24, 0xA8, 0x7BC;
    uint lvl : "mono.dll", 0x001F36AC, 0x18, 0xED4, 0xC, 0x434;
}
